<!DOCTYPE html>
<html lang="{{ app()->getLocale() }}" dir="{{ config('lang.direction', 'ltr') }}">
        ...
        <div
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    ...
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                        ...
                        <a href="https://laracasts.com"
                            ...
                            <div class="pt-3 sm:pt-5">
                                ...
                                <p class="mt-4 text-sm/relaxed">
                                    AALaracasts offers thousands of video tutorials on Laravel, PHP, and JavaScript
                ...
                <footer class="py-16 text-center text-sm text-black dark:text-white/70">
                    ...
                    @if($instagram)
                        <div class="mb-4">
                            <a href="{{ $instagram }}" target="_blank" class="text-[#FF2D20] hover:underline">
                                Instagram: {{ $instagram }}
                            </a>
                        </div>
                    @endif
